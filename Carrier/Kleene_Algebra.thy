...
(* You shouldn't need to worry about how this works, but some of the
lemmas below might be useful if you want to try proving them, so I've
commented it out rather than deleting it *)
...
(* Tactic to solve Kleene algebra closure conditions *)
